...
<h1>WELCOME TO SPRING MVC</h1>
	...
	<div id="navigation">
	  ...
	  <p> <a href="javascript:void(0);"  id="search"> SEARCH EMPLOYEE </a> </p>
	  <p> <a href="javascript:void(0);"  id="update"> UPDATE EMPLOYEE </a> </p>
	  <p> <a href="javascript:void(0);"  id="delete"> DELETE EMPLOYEE </a> </p>
	</div>
